...
OI_OPT_REL_VOL_MIN    = 1.4    # underlying stock's own paced volume vs prev day — the "> 2x" leg
...
DZ_IMPULSE_VOL_RATIO  = 1.5   # impulse candle's volume vs the avg volume of the days before the base — rolled back 2026-07-13, see PDH_VOL_MIN note
...
EXH_VOL_RATIO          = 1.0      # min paced-volume ratio vs prev day
...
PDH_RSI_PERIOD = 14
PDH_RSI_MIN    = 60.0
PDH_VOL_MIN    = 700_000   # 10 lakh shares — rolled back 2026-07-13, auto-tuner had been tuning off production's data (API_BASE bug), see commit
...
ORB_VOL_RATIO             = 1.2    # breakout candle volume vs avg volume of the consolidation bars — rolled back 2026-07-13, see PDH_VOL_MIN note
...
MB_VOL_RATIO          = 1.2   # breakout candle volume vs avg volume of bars so far today — rolled back 2026-07-13, see PDH_VOL_MIN note
...
TRAP_VOL_RATIO        = 1.2   # reversal candle's volume vs avg volume of bars so far today — rolled back 2026-07-13, see PDH_VOL_MIN note
