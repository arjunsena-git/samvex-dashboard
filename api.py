...
DZ_IMPULSE_VOL_RATIO  = 1.9   # impulse candle's volume vs the avg volume of the days before the base
...
PDH_RSI_PERIOD = 14
PDH_RSI_MIN    = 60.0
PDH_VOL_MIN    = 1_900_000   # 10 lakh shares
...
ORB_VOL_RATIO             = 1.9    # breakout candle volume vs avg volume of the consolidation bars
...
MB_VOL_RATIO          = 2.7   # breakout candle volume vs avg volume of bars so far today
...
TRAP_VOL_RATIO        = 2.3   # reversal candle's volume vs avg volume of bars so far today
